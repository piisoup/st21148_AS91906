...
class FormFrame(Frame):
    def __init__(self, parent, controller):
        ...
        # load an image file into an object x
        x = PhotoImage(file="Images/iStock-1079800720-scaled-removebg-preview.png")

        # downsize the image to 1/4th of the priginal
        x = x.subsample(4)

        cat_image= Label(self, image=x)

        # instead of text assign an image to the label
        cat_image.grid(row=10, column=0, columnspan=3, pady=(13, 0), padx=10, sticky='nsew')
